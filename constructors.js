...
User.prototype.removeSavedPost = function(id) {
  let post = this.savedPosts.filter(el => id === el.id)
  let index = this.savedPosts.indexOf(post)
...
//   return this.savedPosts[index].rating = (this.savedPosts[index].rating + newRating)/2;
// }
